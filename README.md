...
# Multiresolution Proper Orthogonal Decomposition (MRPOD)

## Introduction

Welcome to ``mrpod``, a Python module for carrying out Multiresolution Proper Orthogonal Decomposition of multi-dimensional time series. Please visit the [homepage](https://mrpod.readthedocs.io) for documentation and examples. To install from a local clone, run `pip install .`.
